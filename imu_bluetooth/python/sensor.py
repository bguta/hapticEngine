...
ADDRESS = "0C4EE4A7-2E5D-FC59-A20C-20DD0444448C" # RFduino Address
...
async def main(ble_address: str):
    ...
    async with BleakClient(device) as client: # connect to the device s
        ...
        for service in client.services: # size should be one
        ...
        await client.start_notify(read_port.uuid, callback) # start the notification fir the read port with the callback function above
